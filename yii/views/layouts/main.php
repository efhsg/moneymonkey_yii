...
$this->registerLinkTag(['rel' => 'icon', 'type' => 'image/x-icon', 'href' => Yii::getAlias('@web/images/money-monkey.ico')]);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
...
<body class="d-flex flex-column h-100">
    ...
    <footer id="footer" class="mt-auto py-3 bg-light">
        <div class="container text-center text-muted">
            <p>&copy; <?= date('Y') ?> MoneyMonkey. All rights reserved.</p>
            <p><?= Html::a('Privacy Policy', ['/site/privacy']) ?> | <?= Html::a('Terms of Service', ['/site/terms']) ?>
            </p>
        </div>
    </footer>
